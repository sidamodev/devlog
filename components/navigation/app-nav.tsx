...
const AppNav = () => {
  ...
  return (
    <nav className="fixed bg-accent flex sm:bg-transparent sm:flex-col bottom-0 items-center sm:h-screen sm:top-0 shrink-0 sm:sticky w-full sm:w-14 sm:pb-20 z-1000">
      <LogoButton />
