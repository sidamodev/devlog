...
export async function CodeBlock({ code, language = 'text' }: HighlightedCodeProps) {
  ...
  return (
    <div className="code-block my-8 overflow-hidden rounded-xl border border-zinc-200 bg-zinc-50 shadow-sm dark:border-zinc-700 dark:bg-[#22272e]">
      <div className="flex items-center justify-between border-b border-zinc-200 bg-zinc-100 px-4 py-1 dark:border-[#444c56] dark:bg-[#2d333b]">
      ...
      <div
        className="code-scroll-area overflow-x-auto pt-3 pb-1 font-mono text-[0.8rem] leading-6 dark:hidden sm:text-sm"
        dangerouslySetInnerHTML={{ __html: lightHtml }}
      />
      <div
        className="code-scroll-area hidden overflow-x-auto pt-3 pb-1 font-mono text-[0.8rem] leading-6 dark:block sm:text-sm"
